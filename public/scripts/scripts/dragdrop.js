            ...
            async end(event) {
                ...
                if (ghostBlock && ghostBlock.dataset.isValidTarget === "true") {
                    ...
                    window.updateCountdown(
                      window.getScheduleBody(),
                      window.currentClassContainer,
                      window.currentClassTitle,
                      window.currentClassTimer,
                      window.nextClassContainer,
                      window.nextClassTitle,
                      window.nextClassTimer
                    );
                }
                if (ghostBlock) {
                    ghostBlock.remove();
